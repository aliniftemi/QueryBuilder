...
public class FileHelper
{
	...
	public static String getStringFrom(String file) throws IOException {
		...
		try (InputStream inputStream = FileHelper.class.getClassLoader().getResourceAsStream(file); InputStreamReader inputStreamReader = new InputStreamReader(inputStream, "UTF-8"); BufferedReader bufferedReader = new BufferedReader(inputStreamReader)) {
