...
public class DatetimeConvertFilterTest
{
	...
	public void testCustom() throws IOException {
		...
		factory.addFilterAt(new DatetimeConvertFilter(new SimpleDateFormat("yyyy/MM/dd HH-mm-ss"), new SimpleDateFormat("yyyy/MM/dd"), new SimpleDateFormat("HH-mm-ss")), DatetimeConvertFilter.class);
