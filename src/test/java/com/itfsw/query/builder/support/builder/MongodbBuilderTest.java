...
public class MongodbBuilderTest
{
	...
	public void testOperatorIn() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"age\":{\"$in\":[1,5,10]}}]}");
	}
	...
	public void testOperatorNotIn() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"age\":{\"$nin\":[1,5,10]}}]}");
	}
	...
	public void testOperatorLess() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"age\":{\"$lt\":50}}]}");
	}
	...
	public void testOperatorGreater() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"age\":{\"$gt\":50}}]}");
	}
	...
	public void testOperatorGreaterOrEqual() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"age\":{\"$gte\":50}}]}");
	}
	...
	public void testOperatorNotBetween() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"age\":{\"$lt\":5,\"$gt\":10}}]}");
	}
	...
	public void testOperatorIsEmpty() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"username\":\"\"}]}");
	}
	...
	public void testOperatorIsNull() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"username\":null}]}");
	}
	...
	public void testOperatorIsNotNull() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"username\":{\"$ne\":null}}]}");
	}
	...
	public void testConditionAnd() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$and\":[{\"username\":\"Mistic\"}]}");

		json = FileHelper.getStringFrom("tasks/condition-and-more.json");
		result = builder.build(json);

		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$and\":[{\"username\":\"Mistic\"},{\"age\":10}]}");
	}
	...
	public void testConditionOr() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$or\":[{\"username\":\"Mistic\"},{\"age\":10}]}");
	}
	...
	public void testConditionNot() throws IOException {
		...
		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$nor\":[{\"$and\":[{\"username\":\"Mistic\"}]}]}");

		json = FileHelper.getStringFrom("tasks/condition-not-and-more.json");
		result = builder.build(json);

		Assert.assertEquals(StringUtils.trimAllWhitespace(result.toString()), "{\"$nor\":[{\"$and\":[{\"username\":\"Mistic\"},{\"age\":10}]}]}");
	}
}